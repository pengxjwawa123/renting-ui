...
const Modal: any = React.forwardRef<any, any>((props, ref) => {
  ...
  return (
    <Portal>
      <div
        className="fixed inset-0 z-50 overflow-y-auto sm:py-8 md:rounded-lg align-middle"
            ...
            >
              {!hideClose ? (
                <div className="">
                  <button
                    onClick={onClose}
                    className={`absolute right-2 top-2 hover:text-th-primary focus:outline-none md:right-2 md:top-2`}
                  >
